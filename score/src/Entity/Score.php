...
use Drupal\score\ScoreInterface;
 ...
 *     "list_builder" = "Drupal\score\ScoreListBuilder",
 *     "views_data" = "Drupal\views\EntityViewsData",
 *     "form" = {
 *       "add" = "Drupal\score\Form\ScoreForm",
 *       "edit" = "Drupal\score\Form\ScoreForm",
 ...
 *   },
 *   base_table = "score",
 *   admin_permission = "administer score",
 *   entity_keys = {
 *     "id" = "id",
 *     "label" = "title",
 *     "uuid" = "uuid"
 *   },
 *   links = {
 *     "add-form" = "/admin/content/score/add",
 ...
 *   },
 *   field_ui_base_route = "entity.score.settings"
 * )
 */
class Score extends ContentEntityBase implements ScoreInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['description'] = BaseFieldDefinition::create('text_long')
      ...
      ->setDescription(t('A description of the score.'))
      ->setDisplayOptions('form', [
        'type' => 'text_textarea',
        'weight' => 10,
      ])
